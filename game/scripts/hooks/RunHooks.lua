...
---@type ResurrectionCosts
local ResurrectionCosts = ModRequire "../ResurrectionCosts.lua"
---@type ResurrectionMenu
local ResurrectionMenu = ModRequire "../ResurrectionMenu.lua"
...
function CoopResurrectionMarkerUsed(marker, args, user)
    ...
    ResurrectionMenu.OpenResurrectionMenu(deadHero, playerKilled, marker, user)
end

-- Register menu handlers globally for UI
_G["HandleResurrectionMenuSelection"] = ResurrectionMenu.HandleResurrectionMenuSelection
_G["HandleResurrectionMenuReturn"] = ResurrectionMenu.HandleResurrectionMenuReturn
